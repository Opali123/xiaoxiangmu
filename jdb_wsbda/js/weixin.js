...
/*-----------------------------------微信分享  页面分享--------------------------*/
var dataForWeixin={		
		img:  'http://www.jdb.games.sinreweb.com/2015/jdb_wsbda/images/fx.png', //带加
		url:	'http://nm.games.sinreweb.com/LFusong/jiaduobao/index.html',
		title:	'为申办冬奥“加”油喝彩！',
		desc:	''
	...
	MenuShareTimeline:function(success,cancel,url,title,img,desc){
		...
		wx.onMenuShareTimeline({
           ...
           success: function (res) {
               //alert('已分享');
			   ga('send','event','JDB_wsbda','fenxiang_pengyouquan','click');
		...
		wx.onMenuShareQQ({
           ...
           success: function (res) {
              //alert('已分享');
			   ga('send','event','JDB_wsbda','fengxiang_QQ','click');
               success && success(res);
           },
           cancel: function (res) {
               //alert('已取消');
       ...
       //alert('已注册获取“分享到 QQ”状态事件');
		 ...
		 wx.onMenuShareAppMessage({
             ...
             success: function (res) {
               //alert('已分享');
			   ga('send','event','JDB_wsbda','fengxiang_pengyou','click');
               Main.get('http://game.sinreweb.com/Doov/Index/jdb_send',{},function(){
		...
		wx.onMenuShareWeibo({
            ...
            success: function (res) {
              //alert('已分享');
			  ga('send','event','JDB_wsbda','fengxiang_Weibo','click');
              success && success(res);
            },
            cancel: function (res) {
              //alert('已取消');
